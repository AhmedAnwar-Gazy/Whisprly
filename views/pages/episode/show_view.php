...
.container-epi {
    max-width: 900px; /* Adjusted max-width for content focus */
...
.episode-title-large {
    font-size: 2.8rem; /* Larger title for episode */
    font-weight: bold;
...
.series-name-link {
    color: #E2725B; /* Warm Coral/Terracotta link color */
...
.audio-player audio {
    width: 100%; /* Make native audio player fill container */
...
.speed-select:hover,
.speed-select:focus {
    border-color: #00697B; /* Deep Teal border on hover/focus */
    outline: none;
}
...
.show-notes-content ul {
    list-style: disc; /* Default disc for unordered list */
...
.add-to-library-button {
    background-color: #00697B; /* Deep Teal for add to library */
}

.add-to-library-button:hover {
    background-color: #005a6a; /* Darker Teal on hover */
}
