...
<style>
    ...
    *::after {
    ...
    .series-cover-large {
        width: 200px;
        /* Fixed width for the large cover */
        height: 200px;
        /* Fixed height */
        border-radius: 0.5rem;
        /* Rounded corners */
        object-fit: cover;
        /* Ensure cover fills the space */
    ...
    .series-info-large {
        ...
        flex-grow: 1;
        /* Allow info to grow on larger screens */
    }
    ...
    .action-buttons-group {
        /* New: Group for subscribe and read book buttons */
        display: flex;
        flex-direction: column;
    ...
    .read-book-button {
        ...
        /* Warm Coral/Terracotta background, similar to play/download */
    }
    ...
    .podcast-player-container .progress-bar {
        ...
        height: 8px;
        /* Height of the track */
        background: linear-gradient(to right, #00697B var(--progress-value, 0%), #d1d5db var(--progress-value, 0%));
        /* Filled track */
        border-radius: 4px;
        outline: none;
        cursor: pointer;
        ...
        --progress-value: 0%;
        /* Custom property for filled part */
    }
    ...
    .podcast-player-container .progress-bar::-webkit-slider-runnable-track {
        ...
        /* Track is handled by linear-gradient on the input itself */
    }
    ...
    .podcast-player-container .volume-container {
        ...
        gap: 0.5rem;
        flex-shrink: 0;
        /* Prevent volume control from shrinking */
        width: 150px;
        /* Fixed width for volume control */
    }
    ...
    .podcast-player-container .volume-slider {
        ...
        width: 100%;
        height: 6px;
        background: linear-gradient(to right, #00697B var(--volume-value, 100%), #d1d5db var(--volume-value, 100%));
        /* Filled track */
        border-radius: 3px;
        outline: none;
        cursor: pointer;
    ...
    .episode-item {
        ...
        display: flex;
        flex-direction: column;
        /* Stack details and actions vertically on small screens */
        gap: 1rem;
    ...
    .related-books-grid {
        ...
        /* Responsive grid for smaller book cards */
        gap: 1rem;
        /* Space between book cards */
    }
    ...
    .pdf-viewer-container {
        ...
        /* White background for the viewer area */
        border: 1px solid #d1d5db;
        border-radius: 0.5rem;
        overflow: hidden;
        ...
        display: flex;
        /* To center iframe if needed, or simply contain it */
        justify-content: center;
        align-items: center;
    ...
    @media (min-width: 768px) {
        ...
        .action-buttons-group {
            /* Group buttons horizontally on larger screens */
            flex-direction: row;
            justify-content: flex-start;
        ...
        .episode-item {
            flex-direction: row;
            /* Arrange details and actions horizontally */
            align-items: center;
        ...
        .podcast-player-container .controls {
            flex-wrap: nowrap;
            /* Prevent controls from wrapping on larger screens */
        }

        .podcast-player-container .progress-container {
            min-width: 250px;
            /* Give more space on larger screens */
        }
    }
