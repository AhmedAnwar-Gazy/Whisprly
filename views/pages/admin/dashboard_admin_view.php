...
<style>
    ...
    .container_page {
        ...
        flex-direction: column;
        max-width: 1000px;
        /* Container width for dashboard content */
        margin: 0 auto;
    ...
    .stat-item {
        ...
        /* Allow items to grow */
        min-width: 150px;
        /* Minimum width for a stat item */
    }

    .stat-number {
        display: block;
        /* Make number a block element */
        font-size: 2.8rem;
        /* Larger number */
        font-weight: bold;
        color: #E2725B;
        /* Warm Coral/Terracotta for numbers */
    ...
    .quick-link-button i {
        ...
        /* Larger icon size */
        color: #FF7F50;
        /* Warm Coral/Terracotta for icons */
    }
        ...
        <div class="container_page">
            ...
            <div class="dashboard-quick-links">
                ...
                <div class="quick-links-grid">
                    <a href="/user_manage" class="quick-link-button"> User Management</a>
                    <a href="/podcast_manage" class="quick-link-button"> podcasts Moderation</a>
                    <a href="/episode_manage" class="quick-link-button"> epesots Management</a>
                    <a href="/book_manage" class="quick-link-button"> books Management</a>
                    <!-- <a href="#" class="quick-link-button"> catagory Management</a>
                    <a href="#" class="quick-link-button"> Reports</a> -->
                </div>
            </div>
