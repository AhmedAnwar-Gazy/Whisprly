...
$router->get('/book/destroy', 'views/book/destroy.php');
...
$router->get('/episode/store', 'views/episode/store.php');
$router->get('/episode/update', 'views/episode/update.php');



$router->get('/podcast_create_view', 'views/podcast/create_view.php');
$router->get('/podcast/destroy', 'views/podcast/destroy.php');
...
$router->get('/podcast/store', 'views/podcast/store.php');
$router->get('/podcast/update', 'viewss/podcast/update.php');
